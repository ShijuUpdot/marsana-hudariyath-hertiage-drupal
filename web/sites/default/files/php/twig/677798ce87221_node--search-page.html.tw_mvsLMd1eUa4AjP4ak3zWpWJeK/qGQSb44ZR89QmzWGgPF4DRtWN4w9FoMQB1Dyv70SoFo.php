...
class __TwigTemplate_480f62ea50a6eb7763b07aa960deefea extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 80, $this->source)))) : (""))];
    ...
    {
        return new Source("", "themes/custom/hudayriyat/templates/content/node--search-page.html.twig", "C:\\xampp\\htdocs\\modorn\\web\\themes\\custom\\hudayriyat\\templates\\content\\node--search-page.html.twig");
    }
