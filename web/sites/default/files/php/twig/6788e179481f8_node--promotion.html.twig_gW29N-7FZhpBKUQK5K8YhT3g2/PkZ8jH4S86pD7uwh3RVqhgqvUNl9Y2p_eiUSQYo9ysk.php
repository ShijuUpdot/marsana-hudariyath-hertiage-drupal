...
class __TwigTemplate_96bfee3ae477356670ae7829de974d5e extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 80, $this->source)))) : (""))];
    ...
    {
        return new Source("", "themes/custom/hudayriyat/templates/content/node--promotion.html.twig", "C:\\xampp\\htdocs\\modorn\\web\\themes\\custom\\hudayriyat\\templates\\content\\node--promotion.html.twig");
    }
