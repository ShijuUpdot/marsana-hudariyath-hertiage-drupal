...
class __TwigTemplate_b6188b8b2ce6c906b89b77b06cda9255 extends Template
{
    private $source;
    private $macros = [];
...
($context["dom_id"] ?? null)) ? (("js-view-dom-id-" . $this->sandbox->ensureToStringAllowed(($context["dom_id"] ?? null), 35, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/custom/hudayriyat/templates/views/News_Listing/views-view--all-news-list.html.twig", "/var/www/html/Hudayriyat/project/web/themes/custom/hudayriyat/templates/views/News_Listing/views-view--all-news-list.html.twig");
    }
