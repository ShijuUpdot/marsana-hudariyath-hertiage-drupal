...
class __TwigTemplate_d4eaca54e6544fdbb0e297c92d4999dc extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 80, $this->source)))) : (""))];
    ...
    {
        return new Source("", "themes/custom/hudayriyat/templates/content/node--stay.html.twig", "C:\\xampp\\htdocs\\modorn\\web\\themes\\custom\\hudayriyat\\templates\\content\\node--stay.html.twig");
    }
