...
class __TwigTemplate_01822aaf5eca3059bba70f9afff33c3d extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 80, $this->source)))) : (""))];
    ...
    {
        return new Source("", "themes/custom/hudayriyat/templates/content/node--news-listing.html.twig", "C:\\xampp\\htdocs\\modorn\\web\\themes\\custom\\hudayriyat\\templates\\content\\node--news-listing.html.twig");
    }
