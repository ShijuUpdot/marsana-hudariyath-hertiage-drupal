...
/* themes/custom/hudayriyat/templates/views/News_Listing/views-view-unformatted--all-news-list-section.html.twig */
class __TwigTemplate_3ffd5fd2a88f66be4885491a6dfbcde7 extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
          ...
          <div class=\"container\">
            ...
            yield "</h2>
                ...
                ";
            // line 31
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(views_embed_view("all_news_list")), "html", null, true);
            yield "
            <!--div class=\"row\">
...
";
    ...
    {
        return "themes/custom/hudayriyat/templates/views/News_Listing/views-view-unformatted--all-news-list-section.html.twig";
    }
    ...
    {
        return array (  85 => 34,  79 => 31,  73 => 28,  69 => 27,  63 => 23,  60 => 22,  57 => 21,  40 => 20,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/custom/hudayriyat/templates/views/News_Listing/views-view-unformatted--all-news-list-section.html.twig", "/var/www/html/Hudayriyat/project/web/themes/custom/hudayriyat/templates/views/News_Listing/views-view-unformatted--all-news-list-section.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("for" => 20, "set" => 21);
        static $filters = array("trim" => 21, "striptags" => 21, "escape" => 27, "render" => 31, "t" => 34);
        static $functions = array("drupal_view" => 31);

        try {
            $this->sandbox->checkSecurity(
                ['for', 'set'],
                ['trim', 'striptags', 'escape', 'render', 't'],
                ['drupal_view'],
                $this->source
            );
