...
//$settings['file_public_base_url'] = 'https://stmodonstagblob.blob.core.windows.net/sthudayriyatblob';
$settings['file_public_base_url'] = 'https://stmodonprod.blob.core.windows.net/sthudayriyatwebmobileblob';
/**
 * Public file path:
 *
...
// $settings['redis.connection']['password'] = 'dPGIO9fbLqsd72CEehAiwFqlaBgVt1h7Sa9679J4NiU=';
// $settings['cache']['default'] = 'cache.backend.redis';
// $settings['redis.connection']['interface'] = 'PhpRedis';
// $settings['redis.connection']['base'] = 7;
