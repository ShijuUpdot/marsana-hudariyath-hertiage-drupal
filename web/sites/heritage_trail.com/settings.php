 ...
 * @endcode
 */
$settings['hash_salt'] = 'uv650sSQW2S2_iqOL_Q7n33tJ8qPXx84mR6m277zca0nMI4Cb83K0e52KPP5Cp_ClpeXU10Ozg';
...
//$settings['file_public_base_url'] = 'https://stvmmodonstagshare.blob.core.windows.net/heritagedev';
$settings['file_public_base_url'] = 'https://stmodonprod.blob.core.windows.net/stheritagetrailprodblob';
/**
 * Public file path:
 *
...
$databases['default']['default'] = array (
	...
	'driver' => 'mysql',
	// 'pdo' => array(
	// 		PDO::MYSQL_ATTR_SSL_KEY => '/home/mod_prod_usr/mod_prod_usr.pem'
	// 	),
	'init_commands' => array(
...
$settings['config_sync_directory'] = "../config/heritage_trail.com/sync";
//$settings['config_sync_directory'] = 'sites/default/files/config_c9NpdDcJbm2n6ohF2qdEEDtrRmGbrXvgrnV3JGOci162RcNq2sTY1FtiXReuUHU31r9QvNSDyA/sync';
