...
namespace Drupal\marsana_custom_configs\Form;
...
class CustomConfigsSettingsForm extends ConfigFormBase {
  ...
  protected function getEditableConfigNames() {
    return [
      'marsana_custom_configs.settings',
    ];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $custom_configs_settings = $this->config('marsana_custom_configs.settings');
    $form['marsana_custom_configs_settings'] = [
      '#type' => 'details',
      '#title' => $this->t('Mail Configurations'),
      '#collapsible' => FALSE,
      '#collapsed' => TRUE,
    ];
    $form['marsana_custom_configs_settings']['vr_custom_configs_email_username'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Mail UserName'),
      '#default_value' => $custom_configs_settings->get('custom_configs_email_username'),
    ];
    $form['marsana_custom_configs_settings']['vr_custom_configs_email_password'] = [
      '#type' => 'textfield',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->hasAnyErrors()) {
      ...
      $this->config('marsana_custom_configs.settings')
        ...
        ->set('custom_configs_upload_menu_title_en', $values['vr_custom_configs_upload_menu_title_en'])
        ->set('custom_configs_upload_menu_title_ar', $values['vr_custom_configs_upload_menu_title_ar'])
        ->save();
