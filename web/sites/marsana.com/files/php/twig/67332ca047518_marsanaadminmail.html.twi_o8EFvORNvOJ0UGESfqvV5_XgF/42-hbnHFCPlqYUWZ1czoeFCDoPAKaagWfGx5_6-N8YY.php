...
/* sites/marsana.com/modules/custom/marsana_ajax_custom_webform/templates/marsanaadminmail.html.twig */
class __TwigTemplate_2c169f1dec68845c7bdd83f0263e1f75 extends Template
{
    private $source;
    private $macros = [];
...
<body>
    <table align=\"center\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" style=\"width:600px;border-collapse:collapse;background-color:#fff;border:#978F76 1px solid\" class=\"w100\">
        ...
        // line 107
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((($__internal_compile_0 = ($context["data"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["name"] ?? null) : null), 107, $this->source), "html", null, true);
        yield " </td>
                            </tr>
                            <tr>
                                <td>Email </td> <td> ";
        // line 110
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((($__internal_compile_1 = ($context["data"] ?? null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["email"] ?? null) : null), 110, $this->source), "html", null, true);
        yield " </td>
                            </tr>
                            <tr>
                                <td>Contact Number  </td> <td> ";
        // line 113
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((($__internal_compile_2 = ($context["data"] ?? null)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2["contact_number"] ?? null) : null), 113, $this->source), "html", null, true);
        yield " </td>
                            </tr>
                            <tr>
                                <td>Message </td> <td> ";
        // line 116
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((($__internal_compile_3 = ($context["data"] ?? null)) && is_array($__internal_compile_3) || $__internal_compile_3 instanceof ArrayAccess ? ($__internal_compile_3["message"] ?? null) : null), 116, $this->source), "html", null, true);
        yield " </td>
                            </tr>
                        </table>
                        </td>
    ...
    {
        return "sites/marsana.com/modules/custom/marsana_ajax_custom_webform/templates/marsanaadminmail.html.twig";
    }
    ...
    {
        return array (  169 => 116,  163 => 113,  157 => 110,  151 => 107,  107 => 66,  40 => 1,);
    }
                ...
                <table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"width:100%;border-collapse:collapse;\">
                    <tr>
                        ...
                        <table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"width:100%;border-collapse:collapse;\">
                            ...
                            <!-- TITLE COMPONENT END -->
                            <tr>
                                <td width=\"140\">First Name </td> <td> {{ data['name'] }} </td>
                            </tr>
                            <tr>
                                <td>Email </td> <td> {{ data['email'] }} </td>
                            </tr>
                            <tr>
                                <td>Contact Number  </td> <td> {{ data['contact_number'] }} </td>
                            </tr>
                            <tr>
...
</html>", "sites/marsana.com/modules/custom/marsana_ajax_custom_webform/templates/marsanaadminmail.html.twig", "/var/www/html/Hudayriyat/project/web/sites/marsana.com/modules/custom/marsana_ajax_custom_webform/templates/marsanaadminmail.html.twig");
    }
