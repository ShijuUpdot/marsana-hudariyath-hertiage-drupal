...
class __TwigTemplate_518a57db8f725bb0da544c6fc5065fad extends Template
{
    private $source;
    private $macros = [];
...
{% if link -%}
  {{ link }}
{%- endif %}
", "modules/contrib/token/templates/token-tree-link.html.twig", "/var/www/html/Hudayriyat/project/web/modules/contrib/token/templates/token-tree-link.html.twig");
    }
