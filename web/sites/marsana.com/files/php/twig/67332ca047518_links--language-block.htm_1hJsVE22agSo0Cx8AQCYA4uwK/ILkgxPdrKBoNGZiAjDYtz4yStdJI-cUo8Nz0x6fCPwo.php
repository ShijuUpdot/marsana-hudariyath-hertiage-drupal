...
/* sites/marsana.com/themes/custom/marsana/templates/block/links--language-block.html.twig */
class __TwigTemplate_3fad1035a77d08ffd4d4b93fb9ac4cd3 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "sites/marsana.com/themes/custom/marsana/templates/block/links--language-block.html.twig";
    }
...
{% endif %}    
{% if langclass == 'ar' %}
    <a class=\"lang\" href=\"{{ engitem.link['#url'] }}\">{{ engitem.link['#title'] }}</a>
{% else %}
    <a class=\"lang\" href=\"{{ aritem.link['#url'] }}\">{{ aritem.link['#title'] }}</a>
{% endif %}  

    ", "sites/marsana.com/themes/custom/marsana/templates/block/links--language-block.html.twig", "/var/www/html/Hudayriyat/project/web/sites/marsana.com/themes/custom/marsana/templates/block/links--language-block.html.twig");
    }
