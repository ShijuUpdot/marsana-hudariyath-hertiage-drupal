...
/* sites/marsana.com/themes/custom/marsana/templates/views/menu/views-view-unformatted--home-shop-menu.html.twig */
class __TwigTemplate_32f377399ddbf74db460d4bf6953cab7 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 20
        yield " <li data-img=\"images/dynamic/shop-heading.jpg\" data-class=\"main-coral-100\">
   <div class=\"container\">
    <div class=\"row\">
     <div class=\"col\">
        ";
        ...
        foreach ($context['_seq'] as $context["key"] => $context["items"]) {
            ...
            foreach ($context['_seq'] as $context["ikey"] => $context["frow"]) {
                ...
                yield "\">";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(Twig\Extension\CoreExtension::upper($this->env->getCharset(), $this->sandbox->ensureToStringAllowed(($context["title"] ?? null), 37, $this->source)));
                yield "</a>
                ";
            }
    ...
    {
        return "sites/marsana.com/themes/custom/marsana/templates/views/menu/views-view-unformatted--home-shop-menu.html.twig";
    }
 ...
 */
#}
 <li data-img=\"images/dynamic/shop-heading.jpg\" data-class=\"main-coral-100\">
   <div class=\"container\">
    <div class=\"row\">
     <div class=\"col\">
            ...
            <div class=\"strip-content\">                 
                {% for ikey, frow in items %}
                    ...
                    {% else %}
                        {% set url_title = title %}
                    {% endif %}
                    <a href=\"{{ link }}#{{ url_title|lower|replace({\" \":\"-\"}) }}\">{{ title|upper|raw }}</a>
                {% endfor %}
            </div>
        {% endfor %}
    </div>
...
</li>", "sites/marsana.com/themes/custom/marsana/templates/views/menu/views-view-unformatted--home-shop-menu.html.twig", "/var/www/html/Hudayriyat/project/web/sites/marsana.com/themes/custom/marsana/templates/views/menu/views-view-unformatted--home-shop-menu.html.twig");
    }
