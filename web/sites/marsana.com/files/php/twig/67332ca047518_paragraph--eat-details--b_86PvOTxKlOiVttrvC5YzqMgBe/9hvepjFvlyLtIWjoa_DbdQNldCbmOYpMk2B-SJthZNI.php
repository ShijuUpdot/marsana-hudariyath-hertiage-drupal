...
/* sites/marsana.com/themes/custom/marsana/templates/paragraphs/eat/paragraph--eat-details--big-image-block.html.twig */
class __TwigTemplate_0f4562156654b3e4a4f3350b6013ccbe extends Template
{
    private $source;
    private $macros = [];
...
($context["paragraph"] ?? null), "isPublished", [], "method", false, false, true, 46)) ? ("paragraph--unpublished") : (""))];
    ...
    <div class=\"container  py-md-5 my-5\">
      <h3 class=\"mb-3\">";
        // line 53
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed((($__internal_compile_2 = CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_title", [], "any", false, false, true, 53)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2[0] ?? null) : null), 53, $this->source));
        yield "</h3>
      <div class=\"row\">
        <div class=\"col-12\">
          ";
        // line 56
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed((($__internal_compile_3 = CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_description", [], "any", false, false, true, 56)) && is_array($__internal_compile_3) || $__internal_compile_3 instanceof ArrayAccess ? ($__internal_compile_3[0] ?? null) : null), 56, $this->source));
        yield "
        </div>
      </div>
    </div>
  ...
  ";
    ...
    {
        return "sites/marsana.com/themes/custom/marsana/templates/paragraphs/eat/paragraph--eat-details--big-image-block.html.twig";
    }
    ...
    {
        return array (  77 => 56,  71 => 53,  65 => 51,  56 => 50,  47 => 49,  45 => 46,  44 => 45,  43 => 44,  42 => 42,);
    }
...
{% block paragraph %}
  ...
  {% endblock %}
{% endblock paragraph %}", "sites/marsana.com/themes/custom/marsana/templates/paragraphs/eat/paragraph--eat-details--big-image-block.html.twig", "/var/www/html/Hudayriyat/project/web/sites/marsana.com/themes/custom/marsana/templates/paragraphs/eat/paragraph--eat-details--big-image-block.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 42, "block" => 49);
        static $filters = array("clean_class" => 44, "escape" => 51, "raw" => 53);
