...
//$settings['file_public_base_url'] = 'https://stvmmodonstagshare.blob.core.windows.net/marsanadev';
$settings['file_public_base_url'] ="https://stmodonprod.blob.core.windows.net/stmarsanaprodblob";
/**
 * Public file path:
 *
...
$settings['config_sync_directory'] = "../config/marsana.com/sync";
