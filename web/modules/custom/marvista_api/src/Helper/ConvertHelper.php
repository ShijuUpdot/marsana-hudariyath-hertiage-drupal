...
class ConvertHelper {
   ...
   */
  public function parseObject($arr) {
   ...
   */
  public function strip4Byte($str) {
    return preg_replace('%(?:
   ...
   *   The plain text.
   */
  public function parsePlain($str) {
   ...
   */
  public function trimDoubleWhiteSpace($param) {
    return preg_replace('/[ \t\r\n][ \t\r\n]+/', ' ', $param);
  }
   ...
   */
  public function trimComplete($str) {
   ...
   */
  public function trimCompleteArray($params = array()) {
    if (is_array($params)) {
   ...
   */
  public function splitString($text, $maxChars = 140, $end = '...') {
  ...
  public function xssClean($data) {
    ...
    /**
     * script clean data input. remove all emoji
     *
     * @param string $text
     *   The text to be processed.
     *
