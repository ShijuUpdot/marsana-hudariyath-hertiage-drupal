...
/**
 * Provides dynamic permissions for Community post of different types.
 *
 * @ingroup community_post
 *
 */
class CommunityPostPermissions{
   ...
   *
   * @return array
   *   The CommunityPost by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (CommunityPost::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\community_post\Entity\CommunityPost $type
   *   The CommunityPost type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(CommunityPost $type) {
    $type_id = $type->id();
