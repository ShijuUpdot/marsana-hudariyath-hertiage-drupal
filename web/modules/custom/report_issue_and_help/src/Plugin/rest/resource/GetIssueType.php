 ...
 *
 * @RestResource(
 *   id = "get_issue_type_resource",
 *   label = @Translation("Issue type Resource"),
 *   uri_paths = {
 *    "canonical" = "/json-api/{version}/{lang}/taxonomy/issue-type"
 *   }
 * )
 */
class GetIssueType extends GetPostsResource {
  ...
  public function get(Request $request, $version, $lang) {
    ...
    $query->condition('vid', 'issue_type');
